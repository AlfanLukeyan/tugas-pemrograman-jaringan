...
class Chat:
    def __init__(self):
        self.sessions={}
        self.users = {}
        self.users['alfan']={ 'nama': 'Alfan', 'negara': 'Indonesia', 'password': 'surabaya', 'incoming' : {}, 'outgoing': {}}
        self.users['widagdo']={ 'nama': 'Ihsan', 'negara': 'Inggris', 'password': 'surabaya', 'incoming': {}, 'outgoing': {}}
        self.users['libirdo']={ 'nama': 'Lihardo', 'negara': 'Inggris', 'password': 'surabaya','incoming': {}, 'outgoing':{}}
        self.groups = {}
        self.realms = {}
        self.realms_info = {}
...
if __name__=="__main__":
    ...
    sesi = j.proses("auth alfan surabaya")
    print(sesi)
